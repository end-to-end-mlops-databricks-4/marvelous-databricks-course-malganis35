...
def delete_volume(w: WorkspaceClient, catalog_name: str, schema_name: str, volume_name: str) -> None:
    """Delete a volume if it exists in the given catalog and schema.
...
def delete_schema(w: WorkspaceClient, catalog_name: str, schema_name: str) -> None:
    """Delete a schema if it exists (must be empty or with force=True).
