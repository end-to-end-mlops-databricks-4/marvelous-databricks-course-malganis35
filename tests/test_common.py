...
# ---------------------------------------------------------------------
from hotel_reservation.marvelous import common


# ---------------------------------------------------------------------
# Tests
# ---------------------------------------------------------------------
def test_is_databricks_true(monkeypatch):
...
def test_is_databricks_false(monkeypatch):
...
def test_get_dbr_token_returns_token(mock_dbutils, mock_spark, monkeypatch):
...
def test_get_dbr_token_raises_when_not_databricks(monkeypatch):
...
def test_get_dbr_host_returns_host(mock_ws_client):
...
def test_create_parser_data_ingestion_command():
...
def test_create_parser_model_train_register_command():
...
def test_create_parser_post_commit_check_command():
...
def test_create_parser_monitor_command():
...
def test_create_parser_invalid_command_raises():
